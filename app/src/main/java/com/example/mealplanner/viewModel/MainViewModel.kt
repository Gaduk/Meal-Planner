...
import com.example.mealplanner.enums.ListType
import com.example.mealplanner.enums.Type
...
open class MainViewModel(private val repository: Repository) : ViewModel() {
    ...
    fun setAdIsLoaded(adIsLoaded: Boolean) {
        this.adIsLoaded = adIsLoaded
    }
    fun getAdIsLoaded() : Boolean {
    ...
    fun setDefaultDishList(uriList : ArrayList<String>, names : ArrayList<String>) {
        addToDishList(
            Dish(
                null,
                uriList[2],
                names[0], "260", Type.SOUP.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
                null,
                uriList[3],
                names[1], "390", Type.MAIN_DISH.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
        ...
        addToDishList(
            Dish(
                null,
                uriList[5],
                names[3], "200", Type.DESSERT.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
                null,
                uriList[6],
                names[4], "350", Type.MAIN_DISH.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
        ...
        addToDishList(
            Dish(
                null,
                uriList[9],
                names[7], "150", Type.SNACK.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
                null,
                uriList[10],
                names[8], "200", Type.OTHER.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
                null,
                uriList[11],
                names[9], "195", Type.OTHER.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
                null,
                uriList[0],
                names[10], "105", Type.OTHER.ordinal,"",
                true, true, true)
        )
        addToDishList(
            Dish(
                null,
                uriList[1],
                names[11], "95", Type.OTHER.ordinal,"",
                true, true, true)
        )
    }
