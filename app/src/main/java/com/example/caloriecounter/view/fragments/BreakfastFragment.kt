...
import com.example.caloriecounter.databinding.FragmentBreakfastBinding
...
class BreakfastFragment : Fragment() {
    ...
    private fun setRecyclerViewLayoutManager() {
        binding.breakfastRecyclerView.layoutManager = LinearLayoutManager(this.context)
    }
    private fun setRecyclerViewAdapter() {
        adapter = RecyclerAdapter(navController)
        binding.breakfastRecyclerView.adapter = adapter

        mainViewModel.getBreakfastList().observe(requireActivity(), Observer {
                breakfastList -> adapter.setList(breakfastList as ArrayList<Dish>?)
