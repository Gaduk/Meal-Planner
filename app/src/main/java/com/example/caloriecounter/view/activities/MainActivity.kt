...
import com.example.caloriecounter.view.fragments.BreakfastFragment
import com.example.caloriecounter.view.fragments.DinnerFragment
import com.example.caloriecounter.view.fragments.DishListFragment
import com.example.caloriecounter.view.fragments.LunchFragment
...
class MainActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isFirstRun(this)) {
            mainViewModel.setDefaultDishList(getDefaultUriList(this))
